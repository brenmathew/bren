  ...
  projectLinks.forEach(link => {
    link.addEventListener("click", function(event) {
      ...
      if (projectTitle === "Super Market sales analysis") {
        ...
        modalDescription = "The following is a dashboard created on customer analysis for an E-commerce website. The visuals can be categorized
          based on sales from each state, revenue generated and the various products purchased.";
